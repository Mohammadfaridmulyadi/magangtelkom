<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #CC0000;">

            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-icon rounded-lg"  style="background-color: #EEEEEE;">
            ...
            <li class="nav-item <?php echo $this->uri->segment(2) === 'daftarProject' ? 'active' : ''; ?>">
                <a class="nav-link" href=" <?php echo base_url('user/daftarProject') ?> ">
                    <i class="fas fa-fw fa-reguler fa-file"></i>
